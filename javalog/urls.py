...
urlpatterns = patterns('',
    ...
    url(r'^getCdn$', getCdn,name='getCdn'),
    url(r'^getDays$', getDays,name='getDays'),
    url(r'^getDay$', getDay,name='getDay'),
    ...
    url(r'^showFile$', showFile,name='showFile'),
    url(r'^editFile$', editFile,name='editFile'),
    url(r'^delFile$', delFile,name='delFile'),
)
